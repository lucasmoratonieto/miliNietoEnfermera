...
function Cuidados() {
  return (
    <section className=" flex flex-col my-10 gap-10 items-center">
        ...
        <p className=" w-[44%] text-xl">La clave es que nos adaptamos a cada paciente, en este apartado pongo los principales pero no dudes en preguntarnos, si lo que buscas no esta aquí</p>
            ...
            {cuidados.map((cuidado) => (
                <li key={cuidado} className="p-5 rounded-3xl min-w-40 shadow-3xl shadow-slate-200 ">
                    <div className="flex flex-col">
                        ...
                        <p className=" text-xl h-60 flex lg:items-center items-center justify-center">{cuidado.text}</p>
                    </div>
                </li>
            ))}
        </ul>
