...
function Intro() {
  return (
    <main className="flex items-center justify-center mt-10 max-md:flex max-md:flex-col gap-4 ">
        <div className=" z-10 relative align-middle justify-center sm:whitespace-nowrap text-gray-800">
            <h1 className=" text-9xl font-semibold font-Arial max-lg:text-8xl mb-10">Mili Nieto</h1>
            <h3 className=" text-3xl mb-10 max-lg:text-2xl">Tú Enfermera de confianza a domicilio.</h3>
        </div>
